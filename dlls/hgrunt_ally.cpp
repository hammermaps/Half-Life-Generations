...
// CheckMeleeAttack1
//=========================================================
auto CHGruntAlly :: CheckMeleeAttack1 ( float flDot, float flDist ) -> bool
{
	CBaseMonster *pEnemy;
...
//=========================================================
auto CHGruntAlly :: CheckRangeAttack1 ( float flDot, float flDist ) -> bool
{
...
// attack. 
//=========================================================
auto CHGruntAlly :: CheckRangeAttack2 ( float flDot, float flDist ) -> bool
{
...
public:
	void Spawn() override;
	Class_T Classify () override { return m_iClass ? m_iClass : CLASS_HUMAN_MILITARY_FRIENDLY; }
